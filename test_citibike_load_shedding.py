#!/usr/bin/env python3
"""
Citi Bike Load Shedding Test Script
...
def main():
    """Run tests with and without load shedding"""
    
    data_file = "/Users/thanhduong/Downloads/2013-citibike-tripdata/201307-citibike-tripdata.csv"
    
    # Test 1: Baseline (no load shedding)
    # print("\n\n")
    # print("TEST 1: BASELINE (No Load Shedding)")
    # print("=" * 70)
    ...
    print(result_shedding)
    
    # # Compare results
    # if result_baseline and result_shedding:
    #     print("\n\n")
    #     print("=" * 70)
    #     print("COMPARISON")
    #     print("=" * 70)
    #     print(f"{'Metric':<30} {'Baseline':<20} {'Load Shedding':<20}")
    #     print("-" * 70)
    #     print(f"{'Matches found':<30} {result_baseline['matches']:<20} {result_shedding['matches']:<20}")
    #     print(f"{'Processing time (s)':<30} {result_baseline['elapsed_time']:<20.4f} {result_shedding['elapsed_time']:<20.4f}")
        
    #     if result_shedding['stats']:
    #         recall = result_shedding['matches'] / max(1, result_baseline['matches'])
    #         print(f"{'Recall':<30} {'100%':<20} {recall*100:<20.2f}%")
            
    #         speedup = result_baseline['elapsed_time'] / max(0.001, result_shedding['elapsed_time'])
    #         print(f"{'Speedup':<30} {'1.0x':<20} {speedup:<20.2f}x")
